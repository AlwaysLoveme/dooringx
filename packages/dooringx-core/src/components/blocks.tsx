		...
		if (state && props.context === 'edit') {
			...
			return (
				...
				>
					...
					<BlockResizer data={props.data} config={props.config} rect={ref} />
					<RotateResizer data={props.data} config={props.config} rect={ref} />
					<RotateReset data={props.data} config={props.config} rect={ref} />
				</div>
			);
		} else {
			const style = {
