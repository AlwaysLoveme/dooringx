...
export function getRect(
	...
	switch (direction) {
		case 'lt':
			calculateTopLeft(item, rotate, curPosition, symmetricPoint);
			break;
		case 'r':
			calculateRight(item, rotate, curPosition, symmetricPoint, itemWH);
			break;
		case 'b':
			calculateBottom(item, rotate, curPosition, symmetricPoint, itemWH);
			break;
		case 'l':
			calculateLeft(item, rotate, curPosition, symmetricPoint, itemWH);
			break;
		case 't':
			calculateTop(item, rotate, curPosition, symmetricPoint, itemWH);
			break;
		case 'rb':
			calculateBottomRight(item, rotate, curPosition, symmetricPoint);
			break;
		case 'rt':
			calculateTopRight(item, rotate, curPosition, symmetricPoint);
			break;
		case 'lb':
			calculateBottomLeft(item, rotate, curPosition, symmetricPoint);
			break;
		default:
			break;
	}
...
function calculateTop(
	...
	const rotatedcurPositon = calculateRotatedPointCoordinate(curPosition, curPoint, -rotate);
